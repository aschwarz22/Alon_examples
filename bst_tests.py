...
#Tree1 is a bstTree
#produces a generator from Tree1 in prefix order
...
#Tree1 is a bstTree
#produces a generator from Tree1 in postfix order
...
#Tree1 is a bstTree
#produces a generator from Tree1 in infix order
